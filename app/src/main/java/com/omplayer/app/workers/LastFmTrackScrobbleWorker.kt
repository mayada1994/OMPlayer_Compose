...
import com.omplayer.app.utils.LibraryUtils.currentTrackProgress
...
class LastFmTrackScrobbleWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        val currentPosition = currentTrackProgress.value
        val track = currentTrack.value

        if (currentPosition == null || track == null) return Result.failure()
